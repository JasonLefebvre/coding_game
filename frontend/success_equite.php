...
if ($paiement_reussi) {
    ...
    <body class="bg-gray-100 flex items-center justify-center h-screen">
        <div class="bg-white shadow-lg rounded-lg p-8 text-center">
            ...
            <p class="text-gray-700 mt-2">Une erreur de traitement est survenue. Veuillez réessayer plus tard.</p>

            <div class="mt-6">
                <a href="index.php" class="px-6 py-2 bg-gray-500 text-white rounded-lg shadow hover:bg-gray-700">
                    🔙 Retour à l'accueil
                </a>
            </div>
        </div>
