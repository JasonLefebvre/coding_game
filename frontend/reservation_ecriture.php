...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    die("Atelier non trouvé.");
}

$atelier_id = $_GET['id'];

// Get workshop details
$query = "SELECT id, nom, description, date, heure_debut, heure_fin, type FROM atelier_equite WHERE id = :id";
...
<head>
    ...
    <title>Réservation - <?= htmlspecialchars($atelier['nom']); ?> - La Ligne 13</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-16">
            <div class="text-center">
                <h1 class="text-3xl font-extrabold tracking-tight text-jaune sm:text-4xl md:text-5xl animate-hidden animate-element">
                    ...
                    <span class="block text-white mt-2"><?= htmlspecialchars($atelier['nom']); ?></span>
                </h1>
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-8">
                        ...
                        <div class="mb-6">
                            <div class="h-48 bg-violet relative rounded-lg overflow-hidden">
                                <img src="../src/img/workshop<?= $atelier['id'] % 5 + 1; ?>.jpg" alt="<?= htmlspecialchars($atelier['nom']); ?>" class="w-full h-full object-cover opacity-70">
                                <div class="absolute inset-0 flex items-center justify-center">
                                    <h3 class="text-2xl font-bold text-white text-center px-4"><?= htmlspecialchars($atelier['nom']); ?></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                <i class="fas fa-map-marker-alt text-violet text-xl w-8"></i>
                                <span class="ml-2"><?= htmlspecialchars($atelier['type']); ?></span>
                            </div>
                        ...
                        <div class="mb-6">
                            <div class="bg-lightgray p-4 rounded-lg">
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-700">Atelier d'équité</span>
    ...
    <script>
        ...
        form.addEventListener("submit", async (event) => {
            ...
            if (error) {
                ...
                setTimeout(() => {
                    window.location.href = "success_equite.php?id=<?= $atelier_id; ?>&payment_id=" + paymentIntent.id;
                }, 2000);
            }
        });
    </script>
