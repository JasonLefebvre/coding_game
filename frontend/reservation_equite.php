...
<head>
    <meta charset="UTF-8">
    <title>Réservation - <?= htmlspecialchars($atelier['nom']); ?></title>
    <script src="https://js.stripe.com/v3/"></script>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100 p-6">
    <div class="max-w-3xl mx-auto bg-white p-6 rounded shadow">
        <h1 class="text-2xl font-bold mb-4"><?= htmlspecialchars($atelier['nom']); ?></h1>
        ...
        <p><strong>Lieu :</strong> <?= htmlspecialchars($atelier['type']); ?></p>
    ...
    <script>
        ...
        document.getElementById("payment-form").addEventListener("submit", async (event) => {
            ...
            if (error) {
                ...
                // Redirect after payment success (optional)
                setTimeout(() => {
