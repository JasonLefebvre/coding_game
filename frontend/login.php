...
<head>
    ...
    <title>Connexion - La Ligne 13</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-16">
            <div class="text-center">
                <h1 class="text-4xl font-extrabold tracking-tight text-jaune sm:text-5xl md:text-6xl animate-hidden animate-element">
                    <span class="block">Connexion</span>
                </h1>
                <p class="mt-6 max-w-2xl mx-auto text-base text-gray-300 sm:text-lg md:text-xl animate-hidden animate-element animate-delay-100">
                    Accédez à votre espace personnel pour gérer vos réservations et suivre vos activités.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="py-16 bg-white">
        <div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-xl p-8 animate-hidden animate-element">
                <h2 class="text-2xl font-bold text-violet mb-6 text-center">Connectez-vous à votre compte</h2>
                ...
                <form action="../backend/user/LoginUser.php" method="POST">
                    ...
                    <div class="mb-6 text-sm">
                        <a href="register.php" class="text-violet hover:text-violet/80">
                            Si vous n'avez pas de compte, enregistrez-vous ici !
                        </a>
                    </div>
