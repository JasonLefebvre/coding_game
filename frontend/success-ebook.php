...
<head>
    ...
    <title>Achat confirmé - La Ligne 13</title>
    ...
    <nav class="bg-white shadow-sm fixed w-full z-50">
        ...
        <div class="sm:hidden hidden" id="mobile-menu">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <a href="ebooks.php" class="border-transparent text-gray-600 hover:bg-gray-100 hover:border-violet hover:text-violet block pl-3 pr-4 py-2 border-l-4 textnavse font-medium">
                    Ebooks
                </a>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-xl p-8 success-card animate-hidden animate-element">
                <div class="text-center mb-8">
                    ...
                    <p class="text-xl text-gray-700 mt-2">Votre achat a été confirmé</p>
                </div>
                
                <div class="bg-lightgray p-6 rounded-lg mb-8">
                    <h3 class="text-xl font-bold text-violet mb-4">Détails de l'achat</h3>
                    
                    <div class="space-y-3">
                        <div class="flex items-center justify-between">
                            <span class="text-gray-600">E-book :</span>
                            <span class="font-semibold">Écrire pour se libérer</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="font-semibold">Audrey Rebout</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="font-semibold">TRX123456789</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center space-y-4">
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-4 mt-6">
                        <a href="#" class="inline-flex items-center justify-center px-6 py-3 bg-violet text-white rounded-md hover:bg-violet/90 transition-colors">
                            <i class="fas fa-download mr-2"></i> Télécharger ma facture
                        </a>
                        
                        <a href="#" class="inline-flex items-center justify-center px-6 py-3 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors">
                            <i class="fas fa-book mr-2"></i> Télécharger l'e-book
                        </a>
                        
                        <a href="myaccount.html" class="inline-flex items-center justify-center px-6 py-3 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition-colors">
    ...
    <footer class="bg-lightgray border-t border-gray-200">
        <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
            <nav class="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
                ...
                <div class="px-5 py-2">
                    <a href="ebooks.html" class="text-base text-gray-600 hover:text-violet">
                        E-books
                    </a>
                </div>
                <div class="px-5 py-2">
